...
def candidate_adv_urls(months_back: int = 4, max_day: int = 14) -> List[str]:
    ...
    # The .zip proved to be the FOIA firm roster (identity only, no AUM).
    # The .xlsx is the fuller Information Report, so it is tried FIRST.
    suffixes = ["_0.xlsx", ".xlsx", "_0.zip", ".zip"]
